...
public class DialogContent extends _Parent{
    ...
    public void  findElementClickFunction(String elementName){
        ...
        public void findElementAndVerifyContainsText(String  elementName,String  msj){
            switch (elementName) {
                case "dashboard":
                    myElement= dashboard;
                    break;
            ...
            verifyElementContainsText(myElement,msj);
        }
